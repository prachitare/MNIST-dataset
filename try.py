...
#Reshape image in 3 dimension (height = 20px, width = 25px, canal = 2)
...
#with dta augmentation the accuracy increases to prevent overfitting, thus the overfitting won't be 100%
...
#confusion matrix is very helpful to check the drawback of the model
